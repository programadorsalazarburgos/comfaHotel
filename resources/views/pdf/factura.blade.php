   ...
   <main>
       <div id="details" class="clearfix">
           ...
           <div id="invoice" style="background-color: antiquewhite;width: 414px;" class="to">
               ...
               <div style="position: relative; top: -20px; left: 0px;" class="date">Saldo Pendiente: {{$hotel_moneda}} {{$saldo_pendiente}}</div>
           </div>
           ...
           <table border="0" cellspacing="0" cellpadding="0" id="items">
               ...
               <tbody>
                   ...
                   <tr>
                       ...
                       <td style="text-align: center;">{{$hotel_moneda}}{{$det->precio_neto}}</td>
               ...
               <tfoot>
                   ...
                   <tr>
                       <td colspan="1"></td>
                       <td colspan="1" style="text-align: center; font-size: 14px;">{{$impuestoNumero1}} {{$impuesto_hab}}% {{$hotel_moneda}}{{$valor_impuesto}}</td>
                       <td style="font-size: 14px;">{{$iva_nombre_consumo}} {{$iva_valor_consumo}}% {{$hotel_moneda}}{{$valor_impuesto_producto}}</td>
                   </tr>
                   <tr>
                       <td colspan="1"></td>
                       @if($impuesto_hab2 != 0)
                       <td colspan="1" style="text-align: center; font-size: 14px;">{{$impuestoNumero2}} {{$impuesto_hab2}}% {{$hotel_moneda}}{{$valor_impuesto2}}</td>
                       @endif
                   </tr>
                   <tr>
                       <td colspan="1"></td>
