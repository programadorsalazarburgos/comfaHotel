<template>
	<main class="main" >
		<div class="col-12">
			<div class="content-header">{{count["tipo_pago"]}}</div>
		</div>
		<section id="extended">
			<div class="row">
				<div class="col-sm-6">
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header">
							<h5 class="card-title">{{count["tipo_pago"]}}</h5>
	...
	export default {
	  ...
	  methods: {
	    ...
	    BorrarDatos()
	    {
	        ...
	        {
	            title: "Borrando",
	            text: "¿Desea borrar de forma permanente este registro?",
	            type: "warning",
	        ...
	        {
	            axios
	            .post(me.base+"/tipo_pagos/borrar",{id:me.selected})
	    ...
	    ListarDatos (page){
                let me=this;
                var url= me.base+'/tipo_pagos/index?page=' + page;
	          ...
	          axios
	            ...
	            .then(function(response)
	            {
	              if (response.data.validate)
	              {
	                ...
	                me.$swal("se ha guardado el registro " + me.nombre + " con éxito");
	                me.ListarDatos();
	                me.VerDato(response.data);
	              } else {
	                me.disablebutton = false;
	                me.$swal("No se ha podido guardar el registro " + me.numero);
	              }
	    ...
	    GuardarEditarDatos()
	    {
	      ...
	      this.$validator.validate().then(valid =>
	      {
	        if (valid)
	        {
	          me.disablebutton = true;
	          axios
	            .post(me.base+"/tipo_pagos/Editar", {
	              id: me.selected,
	              nombre : me.nombre,
	            ...
	            .then(function(response) {
	              if (response.data.validate) {
	                me.$swal("se ha editado el registro " + me.nombre + " con éxito");
									me.ListarDatos();
	                me.VerDato(response.data);
	              } else {
	                me.$swal("Se presento un problema al editar registro " + me.nombre + ".");
	              }
	              me.disablebutton = false;
	            })
	            .catch(function(error) {
