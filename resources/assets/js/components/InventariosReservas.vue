                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    <button href="javascript:void(0)" type="button" class="btn btn-raised gradient-mint white shadow-z-4" @click="abrirModal('data','registrar')">Crear Inventario <i class="ft-plus-square"></i></button>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" v-on:change="selectTipoHabitacion()" v-model="tipo_habitacion" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" v-model="disponibilidad" required class="form-control"><br>
                                                <span class="badge badge-danger mb-1 mr-2">Total Habitaciones: {{totalHabitaciones}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            registrarData() {
                let me = this;
                if (me.disponibilidad > me.totalHabitaciones) {
                  me.$swal({
                      title: "Tu Disponibilidad no puede ser mayor!",
                      text: "Cambia este valor",
                      icon: "error",
                      button: "Aww yiss!",
                  });
                }
                    ...
                    if ((new Date(me.fecha_desde).getTime() > new Date(me.fecha_hasta).getTime())) {
                        ...
                        axios
                            ...
                            .then(function(response) {
                                me.registrarDataOrbe(me.tipo_habitacion, me.fecha_desde, me.fecha_hasta, me.disponibilidad)
            ...
            registrarDataOrbe(tipo_habitacion, fecha_desde, fecha_hasta, disponibilidad)
            {
              console.log(tipo_habitacion, fecha_desde, fecha_hasta, disponibilidad);
            },

            selectTipoHabitacion()
            {
              let me = this;
              var url = '/inventarios/total_habitaciones?tipo_habitacion=' + me.tipo_habitacion;
              axios.get(me.base + url).then(function(response) {
                      var respuesta = response.data.datos;
                      console.log(respuesta);
                      me.totalHabitaciones = respuesta;
                  })
            ...
            cargarHabitaciones() {
                let me = this;
                axios
                    .get(me.base + "/tipo_habitaciones/listar")
                    .then(function(response) {
                        var data = response.data;
            ...
            datosHabitaciones() {
                ...
                axios
                    .get(me.base + "/tipo_habitaciones/Inventario")
                    .then(function(response) {
                        var data = response.data;
                        me.scheduler.update({
