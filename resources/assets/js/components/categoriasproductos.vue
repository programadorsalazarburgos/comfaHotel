                        ...
                        <div class="container-fluid">
                            <form @submit.prevent="handleSubmit">
                                <div class="col-sm-12">
                                    ...
                                    <input type="text" v-validate="'required'" class="form form-control" v-model="categoriaNombre" :class="{ 'is-invalid': submitted && errors.has('password') }" />
                                    <div v-if="submitted && errors.has('categoriaNombre')" class="invalid-feedback">{{ errors.first('categoriaNombre') }}</div>
                                </div>
...
export default {
    ...
    methods: {
        ...
        ListarDatos(page) {
            let me = this;
            var url = me.base + '/categorias_productos/index?page=' + page;
        ...
        VerDato(data) {
            ...
            me.tipoGuardar = 1;
            me.selected = data.id;
            me.categoriaNombre = data.nombre;
        ...
        GuardarNuevoDatos() {
            ...
            this.$validator.validate().then(valid => {
                if (valid) {
                    ...
                    axios
                        .post(me.base + "/categorias_productos/store", {
                            nombre: me.categoriaNombre
                        ...
                        .then(function (response) {
                            if (response.data.validate) {
                                ...
                                me.$swal("se ha guardado el categoria " + me.categoriaNombre + " con éxito");
                                me.ListarDatos();
                                ...
                                me.disablebutton = false;
                                me.$swal("No se ha podido guardar la categoria " + me.numero);
                            }
                        }).catch(function (error) {
                            console.log(error)
                        });
        ...
        GuardarEditarDatos() {
            ...
            this.$validator.validate().then(valid => {
                if (valid) {
                    me.disablebutton = true;
                    axios
                        .post(me.base + "/categorias_productos/Editar", {
                            id: me.selected,
                            nombre: me.categoriaNombre,
                        ...
                        .then(function (response) {
                            if (response.data.validate) {
                                me.$swal("se ha editado el impuesto " + me.categoriaNombre + " con éxito");
                                me.ListarDatos();
                                me.VerDato(response.data);
                            } else {
                                me.$swal("Se presento un problema al editar impuesto " + me.categoriaNombre + ".");
                            }
                            me.disablebutton = false;
                        })
                        .catch(function (error) {
