...
<main class="main">
    <div class="col-12">
        <div class="content-header">Impuestos</div>
    </div>
    <section id="extended">
        <div class="row">
            <div class="col-sm-9">
                                ...
                                <table class="table table-responsive-md-md text-center">
                                    ...
                                    <tbody>
                                        <tr v-for="impuestos in ArrayImpuestos" :key="impuestos.id">
                                            ...
                                            <td>
                                                <template v-if="impuestos.principal == true">
                                                    <span class="badge badge-danger">Principal</span>
                                                </template>
                                            </td>
                                            <td>
                                                <template v-if="impuestos.ish == true">
                                                    <span class="badge badge-success">Impuestos Ish</span>
                                                </template>
                                            </td>
                                            <td>
                                                <template v-if="impuestos.servicio == true">
                                                    <span class="badge badge-info">Impuestos Servicios</span>
                                                </template>
                                            </td>
                                            <td>
                                                <a class="info p-0" data-original-title="" title="" @click="PrincipalImpuesto(impuestos)">
                                                    <i class="ft-check-square font-medium-3 mr-2"></i>
                                                </a>

                                                <a class="success p-0" data-original-title="" title="" @click="IshImpuesto(impuestos)">
                                                    <i class="fa fa-caret-square-o-up font-medium-3 mr-2"></i>
                                                </a>
                    ...
                    <div class="card-header">
                        ...
                        <div class="container-fluid">
                            <form @submit.prevent="handleSubmit">
                                ...
                                <br>
                                <div class="col-sm-12">
                                    <button :disabled="disablebutton" v-if="tipoGuardar==1" @click="GuardarEditarImpuestos()" class="btn btn-raised gradient-ibiza-sunset white sidebar-shadow"> Actualizar</button>
                                    <button :disabled="disablebutton" v-if="tipoGuardar==1" @click="BorrarImpuestos()" class="btn btn-danger"> Borrar</button>
                                    <button :disabled="disablebutton" v-if="tipoGuardar==2" @click="GuardarNuevoImpuestos()" class="btn btn-raised gradient-nepal white card-shadow"><i class="fa fa-plus" aria-hidden="true"></i> Guardar</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        ListarImpuestos(page) {
            let me = this;
            var url = me.base + '/impuestos/index?page=' + page;
        ...
        PrincipalImpuesto(data) {
            let me = this;
            me.impuesto_id = data.id;

            me.$swal({
                title: "Principal",
                text: "¿Desea que este impuesto sea el principal?",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
                ...
                axios
                    .post(me.base + "/impuestos/principal", {
                        impuesto_id: me.impuesto_id
                    })
                    .then(function (response) {
                        ...
                        if (isConfirm) {
                            me.$swal({
                                title: 'Principal',
                                text: 'Este impuesto quedo como principal',
                                icon: 'success'
                            }).
                            then(function () {
                                me.ListarImpuestos();
        ...
        ServicioImpuesto(data) {
            ...
            me.$swal({
                ...
                axios
                    .post(me.base + "/impuestos/servicio", {
                        impuesto_id: me.impuesto_id
        ...
        IshImpuesto(data) {
            ...
            me.$swal({
                title: "Impuesto ISH",
                text: "¿Desea que este impuesto sea el ISH?",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
                confirmButtonText: "Si, Asignar"
                ...
                axios
                    ...
                    .then(function (response) {
                        ...
                        if (isConfirm) {
                            me.$swal({
                                title: 'ISH',
                                text: 'Este impuesto quedo como ISH',
                                icon: 'success'
                            }).
                            then(function () {
                                me.ListarImpuestos();
