...
<div>
    ...
    <section id="extendeds">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">
                                ...
                                <button class="btn btn-warning" v-on:click="cargarInfo()">
                            ...
                            <div v-if="arrayDataGrupos.length>0">
                                <div class="row">
                                    <div class="col-md-2 col-md-offset-1"><strong>RESERVANTE:</strong><br>{{data_reserva.source.data.text}}</div>
                                    <div class="col-md-2"><strong>NÚMERO DE HUÉSPEDES:</strong><br>{{data_reserva.source.data.cantidad_huespedes}}</div>
                                    <div class="col-md-2"><strong>FECHA DE RESERVA:</strong><br>{{data_reserva.source.data.fecha_reserva}}</div>
                                    <div class="col-md-2"><strong>ESTADO RESERVA:</strong><br>RESERVADO</div>
                                    <div class="col-md-2"><strong>TOTAL RESERVA:</strong><br>${{data_reserva.source.data.precio_total}}</div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2"><strong>HABITACIONES:</strong><br>
                                        <span v-for="dato in arrayDataGrupos">
                                            {{dato.habitacion_numero}} HAB.
                                        </span>
                                    </div>
                                    <div class="col-md-2"><strong>FECHA ENTRADA:</strong><br>{{data_reserva.source.data.check_in_fecha}}</div>
                                    <div class="col-md-2"><strong>FECHA DE SALIDA:</strong><br>{{data_reserva.source.data.fecha_salida}}</div>
                                    <div class="col-md-2"><strong>FUENTE DE RESERVA:</strong><br>{{data_reserva.source.data.nombre_fuente}}</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2"><strong>SALDO PENDIENTE:</strong><br>${{data_reserva.source.data.precio_total - monto_pago}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-sm-12" v-if="arrayDataGrupos.length>0">
            <div class="card ">
                <div class="card-header ">
                    ...
                    <div class="card-body " style="height: auto !important;">
                        <div class="card-block" style="overflow-x:auto;">
                            <table class="table table-responsive-md-md text-center ">
                                ...
                                <tbody>
                                    <tr v-for="dato in arrayDataGrupos" :key="dato.id ">
                ...
                <div class="modal-content" style="height: 580px;">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" method="post" v-if="crearmiscuentas===1" @submit.prevent="registrarCuenta" enctype="multipart/form-data" class="form-horizontal">
                            <center>
                                <h5 style="padding:0px;">Creación Cuenta
                        ...
                        <form action="" method="post" @submit.prevent="registrarCambio" enctype="multipart/form-data" class="form-horizontal">
                            <center>
                                <h5 style="padding:0px;">Cambio de Cuenta
                                    <hr style="width:70%;border:3px dotted #1976d2;">
                                </h5>
                            </center>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="text-input">Cuenta(*)</label>
...
export default {
    ...
    methods: {
        ...
        registrarConsumo() {
            ...
            if (me.unidad === 0 || me.unidad === null || me.unidad === '') {
                ...
                axios.post(me.base + '/reservas/crear_consumos', {
                    ...
                    me.cuenta_consumo = '';
                    me.miarreglo = [];
                    me.data_reserva.source.data.precio_total = response.data.datos;
                ...
                if (result.value) {
                    ...
                    axios
                        ...
                        .then(function (response) {
                            ...
                            me.monto_pagado();
                            me.miarreglo = [];
                            me.data_reserva.source.data.precio_total = response.data.data;
                            var url_detalles = '/obtener/cuentasDetalles?reserva_id=' + me.id_reserva;
                            axios.get(me.base + url_detalles).then(function (response) {
                                    var respuesta = response.data;
                                    me.miarreglo = respuesta;
        ...
        async traerGrupos() {
            var url = 'reservas/data_grupos?reserva_id=' + this.id_reserva;
            await axios.get(this.base + url).then(function (response) {
        ...
        getGrupos() {
            let me = this;
            var url = 'reservas/data_grupos?reserva_id=' + me.id_reserva;
            axios.get(me.base + url).then(function (response) {
                    me.arrayDataGrupos = response.data;
                    console.log(me.arrayDataGrupos);
                })
                .catch(function (error, otracosa) {});
        ...
        getCuentas() {
            let me = this;
            var url = 'reservas/data_cuentas?reserva_id=' + me.id_reserva;
            axios.get(me.base + url).then(function (response) {
                    this.miarreglo = response.data;
                })
                .catch(function (error, otracosa) {});
